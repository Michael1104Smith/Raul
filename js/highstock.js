...
(function(L, ga) {
    ...
    function X(a, b, c) {
        var d, e;
        if (Ca(b)) v(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
        else if (v(b) && ea(b))
    ...
    var t, H = L.document,
        ...
        Ib =
        0,
        ob, R, na, M, ra = function() {},
        $ = [],
        kb = 0,
        Va = "div",
        $b = /^[0-9]+$/,
        tb = ["plotTop", "marginRight", "marginBottom", "plotLeft"],
        ba, pb, yb, fb, Bb, Cb, Db, ab, hb, ib, Pb, Qb, Rb, Sb, qb, Eb, Fb, I = {},
        B;
    B = L.Highcharts ? ga(16, !0) : {
        win: L
    };
    B.seriesTypes = I;
    var Ra = [],
        wa, sa, o, Fa, Jb, ta, E, T, O, db, Sa;
    xb.prototype = {
        dSetter: function() {
            var a = this.paths[0],
                b = this.paths[1],
    ...
    O = function(a, b, c, d) {
        ...
        e = a.hcEvents;
        var f, g, c = c || {};
        if (H.createEvent && (a.dispatchEvent || a.fireEvent)) e = H.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, A(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e);
        else if (e) {
            e = e[b] || [];
            f = e.length;
    ...
    va.prototype = {
        ...
        brighten: function(a) {
            ...
            if (this.stops) o(this.stops, function(b) {
                ...
                for (b = 0; b < 3; b++) c[b] += K(a * 255), c[b] < 0 && (c[b] = 0), c[b] > 255 && (c[b] = 255);
            return this
        },
    ...
    Z.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !v(g.gradientUnits) && (h = g, g = z(g, d.getRadialAttr(n, h), {
                    gradientUnits: "userSpaceOnUse"
                }));
        ...
        on: function(a, b) {
            ...
            cb && a === "click" ? (d.ontouchstart = function(a) {
                ...
                (Na.indexOf("Android") ===
                    -1 || ba.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
            }) : d["on" + a] = b;
            return this
        },
        ...
        zIndexSetter: function(a, b) {
            ...
            if (e) {
                ...
                for (i = 0; i < d.length && !h; i++)
                    if (e = d[i], f = e.zIndex, e !== g && (K(f) > a || !v(a) && v(f))) c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    xa.prototype = {
            ...
            !f && !p && !r && e.indexOf(" ") === -1 ? b.appendChild(H.createTextNode(x(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, F && F.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e = Fa(e, function(a) {
                ...
                o(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        i.test(e) && !d && (X(s, "onclick", 'location.href="' + e.match(i)[1] + '"'), N(s, {
                            cursor: "pointer"
                        }));
                        e = x(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            if (m) {
                                for (var p = e.replace(/([^\^])-/g, "$1- ").split(" "), q = g.length > 1 || f || p.length > 1 && l.whiteSpace !== "nowrap", o, D, v = [], w = u(s), t = 1, y = a.rotation, A = e, B = A.length;
                                    (q || r) && (p.length || v.length);) a.rotation = 0, o = a.getBBox(!0), D = o.width, !ja && c.forExport && (D = c.measureSpanWidth(s.firstChild.data, a.styles)), o = D > m, j === void 0 && (j = o), r && j ? (B /= 2, A === "" || !o && B < 0.5 ? p = [] : (A = e.substring(0, A.length + (o ? -1 :
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            else if (j.test(a)) l = function(a, b) {
                a.element &&
                    (a.attr({
                        width: b[0],
                        height: b[1]
        ...
        text: function(a, b, c, d) {
            var e = qa || !ja && this.forExport,
                f = {};
            if (d && (this.allowHTML ||
                    !this.forExport)) return this.html(a, b, c);
            f.x = Math.round(b || 0);
    ...
    if (!ja && !qa) aa = {
        ...
        getSpanCorrection: function(a, b, c, d, e) {
            ...
            e && e !== "left" && (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), N(this.element, {
                textAlign: e
            }))
        },
        ...
        init: function(a, b, c, d) {
            var e;
            this.alignedObjects = [];
            d = this.createElement(Va).css(A(this.getStyle(d), {
                position: "relative"
            }));
            e = d.element;
            ...
            return A(e, {
                ...
                getCSS: function(a) {
                    var b = a.element,
                        ...
                        f = d + this.height,
                        d = {
                            clip: "rect(" + y(a ? e : d) + "px," + y(a ? f : b) + "px," + y(a ? b : f) + "px," + y(a ? d : e) + "px)"
                        };
                    !a && rb && c === "DIV" && A(d, {
                        width: b + "px",
                        height: f + "px"
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill")
                    if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, u = 'angle="' + (90 - Y.atan((m - a) / (n - c)) * 180 / Aa) + '"', Q();
                    else {
                        var j = m.r,
                            ha = j * 2,
                            v = j * 2,
    ...
    bb.prototype = {
        addLabel: function() {
            ...
            v(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = v(b) &&
        ...
        handleOverflow: function(a) {
            var b = this.axis,
                ...
                n,
                p = {};
            if (h) h < 0 && c - i * j < f ? n = y(c / ca(h * pa) - f) : h > 0 && c + i * j > e && (n = y((d - c) / ca(h * pa)));
            else if (d = c + (1 - i) * j, c - i * j < f ? l = a.x + l * (1 - i) - f : d > e && (l = e - a.x + l * i, m = -1), l = G(k, l), l < k && b.labelAlign === "center" && (a.x += m * (k - l - i * (k - G(j, l)))), j > l || b.autoRotation && g.styles.width) n = l;
            if (n) {
                p.width = n;
    ...
    J.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: z(W.line.dataLabels.style, {
                    color: "#000000"
                })
            }
        },
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = La(h, this);
                ...
                for (; f-- && g === t;) c = Math.pow(1E3, f + 1), a >= c && b * 10 %
        ...
        getSeriesExtremes: function() {
            ...
            o(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && e <= 0 && (e = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) c = Ma(d), !C(c) && !(c instanceof ba) && (d = Fa(d, function(a) {
                            return C(a)
        ...
        setAxisTranslation: function(a) {
            var b = this,
                ...
                k = b.isXAxis;
            if (k || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : (e = b.getClosest(),
        ...
        setTickInterval: function(a) {
            ...
            if (C(d.ceiling)) b.max =
                G(b.max, d.ceiling);
            if (r && v(b.dataMin))
                if (p = p || 0, !v(u) && b.min < p && b.dataMin >= p) b.min = p;
                else if (!v(x) && b.max > p && b.dataMax <= p) b.max = p;
        ...
        getOffset: function() {
            ...
            }).add(Q), a.axisGroup = c.g("axis").attr({
                zIndex: d.zIndex || 2
            }).add(Q), a.labelGroup = c.g("axis-labels").attr({
                zIndex: r.zIndex || 7
            }).addClass("highcharts-" +
            ...
            if (p && p.text && p.enabled !== !1) {
                if (!a.axisTitle)(D = p.textAlign) || (D = (g ? {
                    low: "left",
                    middle: "center",
                    high: "right"
                } : {
        ...
        drawCrosshair: function(a, b) {
            var c, d = this.crosshair,
                e, f;
            if (!this.crosshair || (v(b) || !q(d.snap, !0)) === !1) this.hideCrosshair();
            else if (q(d.snap, !0) ? v(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : q(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null) this.hideCrosshair();
    ...
    J.prototype.normalizeTimeTickInterval = function(a, b) {
        ...
        for (g = 0; g < c.length; g++)
            if (d = c[g], e = M[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + M[c[g + 1][0]]) / 2) break;
        e === M.year &&
            a < 5 * e && (f = [1, 2, 5]);
    ...
    J.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = y(a), i = this.getLinearTickPositions(a, b, c);
        else if (a >= 0.08)
    ...
    Lb.prototype = {
        ...
        getPosition: function(a, b, c) {
            var d = this.chart,
                ...
                l = function(a, b, c, d, h, i) {
                    ...
                    else if (j) f[a] = G(i - c, l - g < 0 ? l : l - g);
                    else if (m) f[a] = w(h, d + g + c > b ? d :
                        d + g);
                    else return !1
                },
                m = function(a, b, c, d) {
        ...
        refresh: function(a, b) {
            ...
            j === !1 ? this.hide() : (this.isHidden && (Sa(d), d.attr("opacity", 1).show()), d.attr({
                text: j
    ...
    Ya.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (B.Tooltip && b.tooltip.enabled) a.tooltip = new Lb(a, b.tooltip), this.followTouchMove = q(b.tooltip.followTouchMove, !0);
            this.setDOMEvents()
        },
        ...
        onContainerClick: function(a) {
            var b = this.chart,
                ...
                e = b.plotTop,
                a = this.normalize(a);
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (O(c.series, "click", A(a, {
                point: c
            })), b.hoverPoint && c.firePointEvent("click", a)) : (A(a, this.getCoordinates(a)),
    ...
    if (L.PointerEvent || L.MSPointerEvent) {
        var Ga = {},
            ...
            ac = function() {
                ...
                for (a in Ga) Ga.hasOwnProperty(a) && b.push({
                    pageX: Ga[a].pageX,
                    pageY: Ga[a].pageY,
                    target: Ga[a].target
                });
    ...
    ub.prototype = {
        ...
        handleOverflow: function(a) {
            ...
            if (a > f && j.enabled !== !1) {
                ...
                b.scroll(0);
                a = f
            } else if (m) F(c.chartHeight), m.hide(), this.scrollGroup.attr({
                translateY: 1
            }), this.clipHeight = 0;
            return a
        },
    ...
    Ba.prototype = {
        ...
        drawChartBox: function() {
            ...
            if (k) f ?
                f.animate(o) : this.plotBackground = b.rect(p, r, s, q, 0).attr({
                    fill: k
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (C(k)) {
                        ...
                        if (s)
                            for (c = 0; c < h; c++) k = a[c], p[c] = k[0], r[c] = k.slice(1, s + 1);
                        else
                            for (c = 0; c < h; c++) k = a[c], p[c] = k[0], r[c] = k[1];
                    else ga(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== t && (k = {
            ...
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = V(g.plotX), e = g.plotY, k = g.graphic, n = g.marker || {}, p = !!g.marker, a = o && n.enabled === t || n.enabled, r = g.isInside, a && C(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = q(n.symbol, this.symbol), j = i.indexOf("url") ===
    ...
    J.prototype.buildStacks =
        function() {
            var a = this.series,
                b, c = q(this.options.reversedStacks, !0),
                d = a.length,
                e;
            if (!this.isXAxis) {
    ...
    P.prototype.setPercentStacks = function() {
        ...
        o([b, "-" + b], function(b) {
            ...
            for (var g = d.length, h, i; g--;)
                if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total : 0, h[0] = ka(h[0] * i), h[1] = ka(h[1] * i), a.stackedYData[g] = h[1]
        })
    };
    ...
    var ya = ma(P, {
        ...
        getStackPoints: function() {
            var a = [],
                ...
                i = d.series,
                j = i.length,
                k, l = q(d.options.reversedStacks, !0) ? 1 : -1,
                m, n;
                ...
                o(b, function(g, i) {
                    ...
                    if (f[g] && !f[g].isNull) a.push(f[g]), o([-1, 1], function(a) {
                        var c = a === 1 ? "rightNull" : "leftNull",
                            ...
                            n = e[b[i + a]];
                        if (n)
                            for (m = h; m >= 0 && m < j;) q = n.points[m], q || (m === h ? f[g][c] = !0 : k[m] && (u = e[g].points[m]) && (d -= u[1] - u[0])), m += l;
    ...
    Ia = ma(P, {
        ...
        drawPoints: function() {
            ...
            o(a.points, function(h) {
                var i = h.graphic,
                    j;
                if (C(h.plotY) && h.y !== null) f = h.shapeArgs, j = v(a.borderWidth) ? {
                        "stroke-width": a.borderWidth
                    } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], i ? (Sa(i), i.attr(j).attr(g)[b.pointCount < e ? "animate" : "attr"](z(f))) : h.graphic =
                    d[h.shapeType](f).attr(j).attr(g).add(h.group || a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
        ...
        drawPoints: function() {
            ...
            o(a.points, function(j) {
                if (j.y !== null) {
                    ...
                    f && f.attr(c);
                    if (d) d.setRadialReference(a.center).attr(g).animate(A(h, c));
                    else {
                        i = {
                            "stroke-linejoin": "round"
                        };
    ...
    P.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (n) d = A({
            ...
            align: m
        }), h = (l + 720) % 360, h = h > 180 && h < 360, m === "left" ? g.y -= h ? j.height : 0 : m === "center" ? (g.x -= j.width / 2, g.y -= j.height / 2) : m === "right" && (g.x -= j.width, g.y -= h ? 0 : j.height)) : (b.align(c, null, d), g = b.alignAttr), p ? this.justifyDataLabel(b, c, g, j, d, e) : q(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)), c.shape && !l && b.attr({
            anchorX: a.plotX,
            anchorY: a.plotY
        });
        if (!n) Sa(b),
        ...
        function() {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                        ...
                        if (m > 0) {
                            ...
                            for (z = 0; z < I; z++) {
                                ...
                                if (J < z && E[z] !== null) J = z;
                                    ...
                                    for (u < I - z + J && E[z] !== null && (J = u - I + z); E[J] === null;) J++;
                                L.push({
                                    i: J,
                                    y: E[J]
                                });
                ...
                if (Da(C) === 0 || this.verifyDataLabelOverflow(C)) this.placeDataLabels(), s && g && o(this.points, function(b) {
                    j = b.connector;
                    x = b.labelPos;
                    if ((F = b.dataLabel) && F._pos && b.visible) A = F._attr.visibility, v = F.connX, t = F.connY, k = l ? ["M", v + (x[6] === "left" ? 5 : -5), t, "C", v, t, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", v + (x[6] === "left" ? 5 : -5), t, "L", x[2], x[3], "L", x[4], x[5]], j ? (j.animate({
                        d: k
                    }), j.attr("visibility", A)) : b.connector = j = a.chart.renderer.path(k).attr({
                        "stroke-width": g,
    ...
    if (I.column) I.column.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart.inverted,
            ...
            i = q(a.below, a.plotY > q(this.translatedThreshold,
                g.yAxis.len)),
    ...
    var mb = B.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            if (e && !c)
                for (k = e + 1; k--;) d[k] === "M" && d.splice(k + 1, 0, d[k + 1] - i, d[k + 2], "L"), (k && d[k] === "M" || k === e) && d.splice(k, 0, "L", d[k - 2] + i, d[k - 1]);
            j ? j.attr({
                d: d
        ...
        pan: function(a, b) {
            ...
            o(b === "xy" ? [1, 0] : [1], function(b) {
                var b = c[b ? "xAxis" : "yAxis"][0],
                    ...
                    i = i > h;
                if (b.series.length && (i || l > G(k.dataMin, k.min)) && (!i || j < w(k.dataMax, k.max))) b.setExtremes(l, j, !1, !1, {
                    trigger: "pan"
                }), e = !0;
                c[d] = h
            });
    ...
    U(J.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        ...
        if (!this.options.ordinal && !this.options.breaks ||
            !f || f.length < 3 || c === t) return a.call(this, b, c, d, e);
        n = f.length;
        for (j = 0; j < n; j++) {
            p = j && f[j - 1] > d;
            f[j] < c && (i = j);
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                if (S(f) > 1) k && o(k, function(a) {
                    ...
                    c.ordinalPositions ? c : m, p = m), m = p.ordinalPositions, h > m[m.length - 1] && m.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, l.apply(k, [n.apply(k, [i, !0]) + f, !0]), l.apply(p, [n.apply(p, [j, !0]) + f, !0])), f.min >= G(g.dataMin, i) && f.max <= w(h, j) && c.setExtremes(f.min, f.max, !0, !1, {
                    trigger: "pan"
        ...
        a.Series.prototype.drawBreaks = function(a, b) {
            ...
            f(b, function(b) {
                ...
                f(e, function(c) {
                    ...
                    f(g, function(b) {
                        j = !1;
                        if (i < b.from && o > b.to || i > b.from && o < b.from) j = "pointBreak";
                        else if (i < b.from && o > b.from && o < b.to || i > b.from && o > b.to && o < b.from) j = "pointInBreak";
                        j && h(a, j, {
                            point: c,
                            brk: b
                        })
    ...
    ia.groupData = function(a,
        ...
        for (; q <= j; q++) {
            ...
            if (p) {
                ...
                var u;
                for (l = 0; l < o; l++)
                    if (u = k[p[l]], C(u)) n[l].push(u);
                    else if (u === null) n[l].hasNulls = !0
            } else if (k = m ? b[q] : null, C(k)) n[0].push(k);
            else if (k === null) n[0].hasNulls = !0
        }
        return [g, h, i]
    };
        ...
        drawPoints: function() {
            ...
            o(a.points, function(o) {
                ...
                if (o.plotY !== t) c = o.pointAttr[o.selected ? "selected" : ""] || d, k = c["stroke-width"] % 2 / 2, l = y(o.plotX) - k, e = o.plotOpen, f = o.plotClose, g = Y.min(e, f), h = Y.max(e,
                    f), p = y(o.shapeArgs.width / 2), i = y(g) !== y(o.plotY), j = h !== o.yBottom, g = y(g) + k, h = y(h) + k, n = [], n.push("M", l - p, h, "L", l - p, g, "L", l + p, g, "L", l + p, h, "Z", "M", l, g, "L", l, i ? y(o.plotY) : g, "M", l, h, "L", l, j ? y(o.yBottom) : h), m ? m.attr(c).animate({
                    d: n
    ...
    I.flags = ma(I.column, {
        ...
        drawPoints: function() {
            var a, b = this.pointAttr[""],
                ...
                f, g, h = this.options,
                i = h.y,
                j, k, l, m, n, p, o = this.yAxis;
            for (k = c.length; k--;)
                if (l = c[k], a = l.plotX > this.xAxis.len, f = l.plotX, f > 0 && (f -= q(l.lineWidth, h.lineWidth) % 2), m = l.stackIndex, j = l.options.shape || h.shape, g = l.plotY, g !== t && (g = l.plotY + i - (m !==
    ...
    Gb.prototype = {
        drawHandle: function(a, b) {
            ...
            this.rendered || (e[b] = c.g("navigator-handle-" + ["left", "right"][b]).css({
                ...
                zIndex: 10 - b
            }).add(), g = c.rect(-4.5, 0, 9, 16, 0, 1).attr(f).add(e[b]), d.push(g), g = c.path(["M", -1.5, 4, "L", -1.5, 12, "M", 0.5, 4, "L", 0.5, 12]).attr(f).add(e[b]), d.push(g));
            e[b][this.rendered ?
                "animate" : "attr"
            ]({
        ...
        drawScrollbarButton: function(a) {
            ...
            this.rendered || (d[a] = b.g().add(this.scrollbarGroup), g = b.rect(-0.5, -0.5, e + 1, e + 1, f.buttonBorderRadius, f.buttonBorderWidth).attr({
                ...
                c.push(g), g = b.path(["M", e / 2 + (a ? -1 : 1), e / 2 - 3, "L", e / 2 + (a ? -1 : 1), e / 2 + 3, e / 2 + (a ? 2 : -2), e / 2]).attr({
        ...
        render: function(a, b, c, d) {
            ...
            if (C(a) && C(b) && (!this.hasDragged || v(c))) {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    a = c - b;
                    if (!L) {
                        if (z) this.navigatorGroup = l = f.g("navigator").attr({
                            zIndex: 3
                        }).add(), this.leftShade = f.rect().attr({
                            fill: s.maskFill
                        }).add(l), s.maskInside ? this.leftShade.css({
                            cursor: "ew-resize"
                    ...
                    if (z) {
                        ...
                        this.outline[f]({
                            d: ["M", i, I, "L", g + b - B, I, g + b - B, I + H, "L", g + c - B, I + H, "L", g + c - B, I, i + j, I].concat(s.maskInside ? ["M", g + b + B, I, "L", g + c - B, I] : [])
                        });
                    ...
                    if (o && k) this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[f]({
                        ...
                        width: j
                    }), g = p + b, h = a - J, h < u && (E = (u - h) / 2, h = u, g -= E), this.scrollbarPad = E, m[f]({
                        x: V(g) + J % 2 / 2,
                        width: h
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d),
                    ...
                    z, A = jb ? 10 : 7;
                if (y > h && y < h + g + j)
                    if ((h = !a.scrollbarEnabled || y < h + g) && Y.abs(w - e - o) < A) a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
                    else if (h && Y.abs(w - f - o) < A) a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null;
                else if (w > o + e - v && w < o + f + v) a.grabbedCenter = w, a.fixedWidth = t, i = w - e;
                else if (w > k && w < k + l) {
                    f = h ? w - o - t / 2 : w < o ? e - t * 0.2 : w > k +
                        l - j ? e + t * 0.2 : w < o + e ? e - t : f;
                    if (f < 0) f = 0;
                    else if (f + t >= q) f = q - t, z = a.getUnionExtremes().dataMax;
                    if (f !== e) a.fixedWidth = t, e = c.toFixedRange(f, f + t, null, z), d.setExtremes(e.min, e.max, !0, !1, {
                        trigger: "navigator"
                    })
                }
            };
            ...
            }), j.userOptions.events = A(j.userOptions.event, {
        ...
        destroy: function() {
            ...
            o([this.xAxis, this.yAxis, this.leftShade, this.rightShade, this.outline, this.scrollbarTrack,
                this.scrollbarRifles, this.scrollbarGroup, this.scrollbar
            ], function(a) {
    ...
    U(P.prototype, "addPoint", function(a, b, c, d, e) {
        ...
        f && this.xData.length > f && ea(b) &&
            !Ja(b) && this.chart.scroller && ga(20, !0);
        a.call(this, b, c, d, e)
    });
    A(R, {
        rangeSelector: {
    ...
    Hb.prototype = {
        clickButton: function(a,
            ...
            var c = this,
                ...
                j = i.dataMin,
                k = i.dataMax,
                l, m = h && y(G(h.max, q(k, h.max))),
                n = g.type,
                p, i = g._range,
                r, s, v, u = g.dataGrouping;
            if (!(j === null || k === null || a === c.selected)) {
                e.fixedRange = i;
                if (u) this.forcedDataGrouping = !0, J.prototype.setDataGrouping.call(h || {
                    chart: this.chart
                }, u, !1);
                if (n === "month" || n === "year")
                    if (h) {
        ...
        setInputValue: function(a, b) {
            ...
            this[a + "DateBox"].attr({
                text: na(c.inputDateFormat || "%b %e, %Y", this[a + "Input"].HCTime)
            })
        },
        ...
        drawInput: function(a) {
            ...
            var c = this,
                ...
                h = c.div,
                i = a === "min",
                j, k, l = this.inputGroup;
            this[a + "Label"] = k = f.label(R.lang[i ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({
                padding: 2
            }).css(z(e, g.labelStyle)).add(l);
            l.offset += k.width + 5;
    ...
    B.StockChart = B.stockChart = function(a, b, c) {
        var d = Ca(a) || a.nodeName,
            e = arguments[d ? 1 : 0],
            f = e.series,
            g, h = q(e.navigator && e.navigator.enabled, !0) ? {
                startOnTick: !1,
                endOnTick: !1
            } : null,
            i = {
    ...
    U(J.prototype,
        ...
        function(a, b, c, d, e, f) {
            ...
            o(g.isXAxis ? i.yAxis : i.xAxis, function(a) {
                if (v(a.options.id) ? a.options.id.indexOf("navigator") ===
                    -1 : 1) {
